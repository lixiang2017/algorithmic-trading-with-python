import numpy as np
import pandas as pd
from src.pypm.data_io import load_eod_data, load_spy_data
...
def calculate_annualized_downside_deviation(
    return_series: pd.Series, benchmark_rate: float = 0
) -> float:
    """
...
def calculate_sortino_ratio(
    price_series: pd.Series, benchmark_rate: float = 0
) -> float:
    """
...
def calculate_max_drawdown_with_metadata(
    series: pd.Series, method: str = "log"
) -> Dict[str, Any]:
    """
